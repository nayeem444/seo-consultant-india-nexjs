  ...
  return (
    <nav className="relative h-16 py-4 flex justify-between items-center bg-white">
		...
		<ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
			...
			<li><a className="text-sm hover:text-blue-600 font-bold hover:font-bold text-gray-800" href="/#about">About Us</a></li>
			<li className="text-gray-300">
				<svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" className="w-4 h-4 current-fill" viewBox="0 0 24 24">
					<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
				</svg>
			...
			<li><a className="text-sm text-gray-800 font-bold hover:text-blue-600 hover:font-bold" href="/#contact">Contact</a></li>
		</ul>
