...
const Service = () => {
  return (
    <section id="services" className="pb-12 pt-20 dark:bg-dark lg:pb-[90px] ">
      <div className="container mx-auto">
        ...
        <div className="-mx-4 flex flex-wrap">
          ...
          <ServiceCard
            ...
            details="Conducting thorough keyword research to identify relevant and high-traffic keywords that customers are using."
            icon={
              // <svg version="1.1" 
              // id="Capa_1" 
              // xmlns="http://www.w3.org/2000/svg"  
